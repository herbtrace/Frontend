    ...
    <div className="space-y-2">
      ...
      <div className="space-y-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div className="space-y-1">
            <Label htmlFor="mfg-id" className="text-xs font-medium text-slate-700">
          ...
          <div className="space-y-1">
            <Label htmlFor="mfg-name" className="text-xs font-medium text-slate-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div className="space-y-1">
            <Label htmlFor="mfg-phone" className="text-xs font-medium text-slate-700">
          ...
          <div className="space-y-1">
            <Label htmlFor="mfg-license" className="text-xs font-medium text-slate-700">
              License Number <span className="text-xs text-slate-500">(Optional)</span>
            </Label>
            <Input
              id="mfg-license"
        ...
        <div className="flex items-center space-x-2 pt-1">
          ...
          />
          <Label htmlFor="gmp-certified" className="text-xs font-medium text-slate-700">
            GMP Certified
          </Label>
        </div>
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="space-y-1">
          <Label htmlFor="mfg-address" className="text-xs font-medium text-slate-700">
