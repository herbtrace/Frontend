    ...
    <div className="space-y-2">
      ...
      <div className="space-y-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          <div className="space-y-1">
            <Label htmlFor="farmer-id" className="text-xs font-medium text-slate-700">
          ...
          <div className="space-y-1">
            <Label htmlFor="farmer-name" className="text-xs font-medium text-slate-700">
          ...
          <div className="space-y-1">
            <Label htmlFor="farmer-phone" className="text-xs font-medium text-slate-700">
        ...
        <div className="w-full md:w-1/3">
          <div className="space-y-1">
            <Label htmlFor="farmer-aadhar" className="text-xs font-medium text-slate-700">
              Aadhar Number <span className="text-xs text-slate-500">(Optional)</span>
            </Label>
            <Input
              id="farmer-aadhar"
      ...
      <div className="space-y-1">
        ...
        <div className="space-y-1">
          <Label htmlFor="farmer-address" className="text-xs font-medium text-slate-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div className="space-y-1">
            <Label htmlFor="farmer-lat" className="text-xs font-medium text-slate-700">
              Latitude <span className="text-xs text-slate-500">(Optional)</span>
            </Label>
            <Input
              id="farmer-lat"
              type="number"
          ...
          <div className="space-y-1">
            <Label htmlFor="farmer-long" className="text-xs font-medium text-slate-700">
              Longitude <span className="text-xs text-slate-500">(Optional)</span>
            </Label>
            <Input
              id="farmer-long"
              type="number"
      ...
      <div className="space-y-1">
        ...
        <div className="space-y-1">
          <Label htmlFor="farmer-land" className="text-xs font-medium text-slate-700">
            Land Records <span className="text-xs text-slate-500">(Optional)</span>
          </Label>
          <Textarea
            id="farmer-land"
