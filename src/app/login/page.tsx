            ...
            <form onSubmit={handleSubmit} className="p-6 md:p-8">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h1 className="text-2xl font-light tracking-wide text-black">Supply Chain Manager</h1>
                  <p className="text-gray-600 text-balance font-light">
                    Sign in to your Herbtrace dashboard
                  </p>
                </div>
                <div className="grid gap-3">
                  <Label htmlFor="email" className="text-gray-700 font-medium">Company Email</Label>
                  <Input
                    id="email"
                    type="email"
