...
const menuItems = [
  ...
  { id: 'create-profile', label: 'Create Profile', icon: Plus, href: '/dashboard/create-profile' },
];
              ...
              {showBreadcrumbs && (
                <Breadcrumb className="mb-2">
                  <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                      <BreadcrumbPage className="text-gray-900 font-medium">Create Profile</BreadcrumbPage>
                    </BreadcrumbItem>
                  </BreadcrumbList>
                </Breadcrumb>
              )}
              <p className="text-sm text-gray-500">Add new entities to the supply chain</p>
            </div>
