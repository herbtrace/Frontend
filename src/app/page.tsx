      ...
      <div className='flex flex-col items-center justify-center min-h-screen px-8'>
        <div className='text-center max-w-4xl'>
          ...
          <div className='mb-8'>
            ...
            <Badge
              variant='secondary'
              className='text-sm px-4 py-1 bg-green-100 text-green-800 border-green-200'
            >
          ...
          <div className='mb-10'>
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed'>
              Track medicinal herbs from farm to pharmacy with end-to-end
              traceability, ensuring authenticity and quality at every step of
              the journey.
            </p>
          </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-3xl mx-auto'>
              <div className='p-6 rounded-lg bg-white/70 backdrop-blur-sm shadow-md hover:shadow-lg transition-shadow'>
                ...
                <p className='text-sm text-gray-600'>
                  Track herbs from cultivation to harvest with verified farmer
                  credentials
                </p>
              </div>
              ...
              <div className='p-6 rounded-lg bg-white/70 backdrop-blur-sm shadow-md hover:shadow-lg transition-shadow'>
                ...
                <p className='text-sm text-gray-600'>
                  Laboratory verification and certification for purity and
                  potency
                </p>
              </div>
              ...
              <div className='p-6 rounded-lg bg-white/70 backdrop-blur-sm shadow-md hover:shadow-lg transition-shadow'>
                ...
                <p className='text-sm text-gray-600'>
                  Secure packaging and transportation with real-time monitoring
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='space-y-6'>
            <div>
              <h3 className='text-lg font-medium text-gray-700 mb-2'>
                Join the Future of Herbal Medicine
              </h3>
              <p className='text-gray-500 text-sm mb-6'>
                Whether you&apos;re a farmer, lab technician, manufacturer, or
                distributor - be part of the transparent supply chain
                revolution.
              </p>
            </div>
